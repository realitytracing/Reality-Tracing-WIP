...
- **[5.1. Local-End Stability: Foundations](constraint-aware-policy-making-and-engineering-strategies/5-1-local-end-stability-foundations.md)** — Core claim, salience deserts, life bandwidth, legitimacy feedback, collapse pathway
- **[5.2. Local-End Stability: Detection and Grounding](constraint-aware-policy-making-and-engineering-strategies/5-2-local-end-stability-detection-and-grounding.md)** — Sufficiency detection, lived validation, participation gradients, groundwork, abstraction drift
- **[5.3. Local-End Stability: Constraint-Aware Governance and Groundwork](constraint-aware-policy-making-and-engineering-strategies/5-3-local-end-stability-governance-and-groundwork.md)** — Triple alignment, groundwork institutions, early detection, governance drift, public reality-sensing capacity
- **[5.4. Local-End Stability: Constraint Diplomacy](constraint-aware-policy-making-and-engineering-strategies/5-4-local-end-stability-constraint-diplomacy.md)** — Shared constraint mapping and cooperation under narrowing feasible regions
- **[5.5. Local-End Stability: Layered Counterbalances for Monocoded Societies](constraint-aware-policy-making-and-engineering-strategies/5-5-local-end-stability-layered-counterbalances-for-monocoded-societies.md)** — Institutional, cultural, and cognitive counterbalances against totalizing coordination cores
