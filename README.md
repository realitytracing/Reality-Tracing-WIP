...
- **[5.1. Local-End Stability: Foundations](constraint-aware-policy-making-and-engineering-strategies/5-1-local-end-stability-foundations.md)** — insert description here
- **[5.2. Local-End Stability: Detection and Grounding](constraint-aware-policy-making-and-engineering-strategies/5-2-local-end-stability-detection-and-grounding.md)** — insert description here
- **[5.3. Local-End Stability: Constraint-Aware Governance and Groundwork](constraint-aware-policy-making-and-engineering-strategies/5-3-local-end-stability-governance-and-groundwork.md)** — applies the doctrine institutionally through adaptation windows, participation gradients, doctrine alignment, and constraint-bounded governance
- **[5.4. Local-End Stability: Constraint Diplomacy](constraint-aware-policy-making-and-engineering-strategies/5-4-local-end-stability-constraint-diplomacy.md)** — defines the sensing function, failure modes, and load-bearing role of groundwork institutions in preventing abstraction drift
- **[5.5. Local-End Stability: Layered Counterbalances for Monocoded Societies](layered-counterbalances-for-monocoded-societies.md)** — reframes international conflict through shared constraint compression and cooperative management of narrowing feasibility regions
