...
These constraints are enforced continuously through lived experience as:  
- Fatigue  
- Overload  
- Stress  
- Confusion  
...
- Dissolves under overload, misalignment, or constraint violation  

Salience is not emotion, thought, intuition, or choice.  
It is the **directional weighting across all of them**.  
...
Cost here includes metabolic energy, attention, cognitive effort, and regulatory load.  
...
All stability remains **conditional and revisable**. When constraints shift or costs exceed available capacity, habituated paths destabilize and require reweighting.  
...
- Experiences that restore or preserve energy or capacity  

Local ends are not ideals or final goals. They are **bounded completions** that make life livable.  
...
These signals indicate **inefficiency and non-viability**, not moral failure.  

Persistent overload destabilizes salience, disrupts habituation, and erodes local ends—often unevenly across capacities.  
...
This loop conserves capacity, exhibits rate sensitivity, and fails predictably under sustained overload or misalignment.  
