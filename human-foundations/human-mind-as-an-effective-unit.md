...
Habituation is the process by which repeated salient paths **reduce energetic cost and variance** over time.
...
All stability remains **conditional and revisable**. When constraints shift or costs exceed capacity, habituated paths destabilize and require reweighting.
...
This loop conserves energy, exhibits rate sensitivity, and fails predictably under sustained overload or misalignment.
