...
- Preventing catastrophic error  
- Preserving systems under stress  
- Managing hard cases and collapse dynamics  
...
- Infinite engagement expectations  
...
- Option space collapses prematurely  
...
- Guilt is reduced where impossibility exists  
