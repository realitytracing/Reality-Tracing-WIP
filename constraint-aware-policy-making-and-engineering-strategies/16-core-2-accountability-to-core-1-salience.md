...
related:
  ...
  - Finiteness, Grounding, and the Non-Optional Need for Coordination
  - Public Rankability, Expert Scope, and the "Shut Up and Reconfigure" Principle
  - Evil, Essence, and Structural Grounding
...
1. The theory defines people’s true interest.
2. Actual people resist, hesitate, prefer otherwise, or fail to care enough.
3. Their resistance is diagnosed as false consciousness.
4. The theory appoints an interpreter of their true interest.
5. Resistance to the interpreter becomes further proof of false consciousness.
6. The loop seals against correction from below.
